...
/**
 * Strings for component 'admin', language 'ja', branch 'MOODLE_23_STABLE'
 *
 * @package   admin
...
$string['configgooglemapkey'] = 'あなたはIPアドレスのルックアップを視覚化するため利用するGoogle Mapsの特殊キーを入力する必要があります。あなたは<a href="https://developers.google.com/maps/documentation/javascript/v2/introduction#Obtaining_Key">https://developers.google.com/maps/documentation/javascript/v2/introduction#Obtaining_Key</a>より、キーを無償で取得することができます。<br />あなたのウェブサイトURIは: {$a}';
...
$string['confignavshowallcourses'] = 'この設定を有効にした場合、ユーザには受講登録しているコースがマイコースおよびコース構造内に表示されます。この設定を無効にした場合、受講登録しているコースはナビゲーションのマイコース内にのみ表示されます。';
...
$string['googlemapkey'] = 'Google Maps API V2キー';
...
$string['registermoodleorgli3'] = 'あなたのサイトがmoodle.orgのオープンコミュニティハブ ({$a}) にも登録されます。同時に「コースをハブに公開する」ケイパビリティの割り当てられたユーザ (通常、マネージャ) はMOOCHにコースを公開することができます。';
$string['registerwithmoodleorg'] = 'moodle.orgに登録する';
$string['registration'] = '登録';
$string['registration_help'] = 'セキュリティメールアラートを受信するため、Moodleの成長および統計に貢献するため、またMOOCH上のコースを共有できるようにするため、Moodle.orgへの登録をお勧めします。';
...
$string['updateminmaturity'] = '必須コード完成度';
...
$string['updatenotificationsubject'] = 'あなたのMoodleサイトに利用可能な更新があります。';
...
* ダウンロードまたはMoodle CVSまたはGITリポジトリから取得した標準Moodleパッケージのみを含む新しいMoodleディレクトリを作成してください。
...
また、この警告はCVS、SVNまたはGITリポジトリからの不完全なチェックアウトまたはアップデート処理により発生することがあります。この場合、処理が完了するまで待つか、適切なクリーンアップコマンドを実行した後、処理を再試行してくだｓだい。
