...
/**
 * Strings for component 'hub', language 'ja', branch 'MOODLE_23_STABLE'
 *
 * @package   hub
...
$string['registermoochtips'] = 'moodle.org オープンコミュニティハブ (MOOCH) に登録されるためには、あなたのサイトがmoodle.orgに登録される必要があります。';
