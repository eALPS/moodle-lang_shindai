...
/**
 * Strings for component 'plugin', language 'ja', branch 'MOODLE_23_STABLE'
 *
 * @package   plugin
...
$string['numextension'] = '拡張機能: {$a}';
$string['numtotal'] = 'インストール: {$a}';
$string['numupdatable'] = '利用可能な更新: {$a}';
$string['otherplugin'] = '{$a->component}';
$string['otherpluginversion'] = '{$a->component}';
$string['pluginchecknotice'] = 'このページではアップグレード中、あなたが注意する必要のあるプラグインを表示しています。ハイライトされた項目にはインストールされる予定の新しいプラグイン、アップグレードされる予定の更新プラグイン、そして不明のプラグインを含みます。コントリビュートプラグインもハイライトされています。さらに新しいバージョンのコントリビュートプラグインがあるか確認して、このMoodleアップグレードを続ける前にソースコードの更新をお勧めします。';
$string['plugindisable'] = '無効';
$string['plugindisabled'] = '無効';
$string['pluginenable'] = '有効';
$string['pluginenabled'] = '有効';
$string['requiredby'] = '次のプラグインに必要: {$a}';
$string['requires'] = '必須';
$string['rootdir'] = 'ディレクトリ';
$string['settings'] = '設定';
$string['showall'] = 'すべてのプラグインをリロードおよび表示する';
$string['somehighlighted'] = 'アップグレード中、あなたの注意が必要なプラグイン数: {$a}';
...
$string['type_repository_plural'] = 'リポジトリー';
