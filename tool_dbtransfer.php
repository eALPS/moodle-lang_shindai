...
/**
 * Strings for component 'tool_dbtransfer', language 'ja', branch 'MOODLE_23_STABLE'
 *
...
$string['transferdbintro'] = 'このスクリプトではデータベースのコンテンツすべてを別のデータベースサーバに転送します。主にデータを異なるデータベースタイプに移行する場合に使用されます。';
