...
/**
 * Strings for component 'auth_shibboleth', language 'ja', branch 'MOODLE_23_STABLE'
 *
...
$string['shib_account_not_mapped_error'] = 'You seem to be Shibboleth authenticated but no corresponding account can be found on the system.';
