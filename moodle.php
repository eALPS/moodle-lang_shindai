...
/**
 * Strings for component 'moodle', language 'ja', branch 'MOODLE_23_STABLE'
 *
 * @package   moodle
...
$string['coursedisplay_help'] = 'この設定では1ページにコース全体を表示するか、複数ページに分割するか決定します。この設定はSCORMフォーマットのような特定のコースフォーマットには影響を及ぼしません。';
...
$string['dndenabled_help'] = '1つまたはそれ以上のファイルをアップロードするため、あなたのデスクトップからボックスにドラッグ＆ドロップすることができます。<br />注意: これは他のブラウザでは動作しない場合があります。';
...
$string['selectmoduletoviewhelp'] = 'ヘルプを表示するには、モジュールを選択してください。';
